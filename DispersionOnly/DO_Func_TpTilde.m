function [TpTilde] = DO_Func_TpTilde(xin, beta2, L, PSWFs, Tw, E, Factor,epsilon)
% This function computes the effective duration of the received signal at
% distance L. The transmitted signal is a combination of the PSWFs where
% xin contains the coefficients of the PSWFs
xin=xin*Factor;
